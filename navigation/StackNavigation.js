...
function StackNavigation({ user }) {
  ...
  const TabNavigationHeader = ({ navigation, route }) => {
    let objURL =
      "https://reference-builer-avatars-dev111859-dev.s3-us-west-2.amazonaws.com/public/avatars/0/avatarb403da70-bea8-4e54-9cff-6a68e9d07f4d.jpeg";
    let key =
      "public/avatars/0/avatarb403da70-bea8-4e54-9cff-6a68e9d07f4d.jpeg";
        ...
        return route.params?.team ? (
          ...
          <View style={styles.container}>
            <Text style={styles.jobTitle}>
              {route.params?.otherUserRatings.jobTitle}
            </Text>
            <Text style={styles.name}>
              {route.params?.otherUserRatings.name}
            </Text>
          </View>
        ) : (
          <View style={styles.container}>
        ...
        return (
          <>
            {navigation.canGoBack() ? (
              <BackButton
                color={{ backgroundColor: "#fff", color: "#0009EE" }}
                size={25}
