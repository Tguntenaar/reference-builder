  ...
  const ratings = [
    {
      ...
      rating: { grade: '9.5', comment: 'This is my comment on this skill. You did a great job.' },
    },
    {
      evaluator: { name: 'Thomas Guntenaar', jobTitle: 'Developer' },
      rating: { grade: '8.5', comment: 'This is my comment on this skill. You did a great job.' },
    },
    {
      evaluator: { name: 'Olivier Guntenaar', jobTitle: 'Developer' },
      rating: { grade: '7.5', comment: 'This is my comment on this skill. You did a great job.' },
    },
  ];
  // <SafeAreaView style={styles.safe}/>
  return (
